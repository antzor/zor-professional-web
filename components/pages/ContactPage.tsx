    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-gray-warm border-b border-gray-border">
        <div ref={headerRef} className="animate-fade-up max-w-7xl mx-auto px-6 lg:px-10 py-16">
          <h1 className="text-gray-900 text-4xl font-black tracking-tight">{t('contact.title')}</h1>
          <p className="text-gray-600 text-lg mt-3 max-w-2xl">{t('contact.subtitle')}</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col gap-6">
              <h3 className="text-gray-900 text-xl font-bold">{t('contact.info.title')}</h3>
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">{t('contact.info.address')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-accent rounded-lg flex items-center justify-center text-primary shrink-0">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">{t('contact.info.phone')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-accent rounded-lg flex items-center justify-center text-primary shrink-0">
